...
public class ProductionLineVO {
    ...
    static {
        ...
        ProductionLineVO p1 = new ProductionLineVO();
        p1.setProductionLineId(1);
        p1.setEnterpriseId(1);
        p1.setEnable(1);
        p1.setCode(1);
        ProductionLineVO p2 = new ProductionLineVO();
        p2.setProductionLineId(2);
        p2.setEnterpriseId(3);
        p2.setEnable(1);
        p2.setCode(1);
        ProductionLineVO p3 = new ProductionLineVO();
        p3.setProductionLineId(3);
        p3.setEnterpriseId(1);
        p3.setEnable(1);
        p3.setCode(1);
        ProductionLineVO p4 = new ProductionLineVO();
        p4.setProductionLineId(4);
        p4.setEnterpriseId(2);
        p4.setEnable(1);
        p4.setCode(1);
        ProductionLineVO p5 = new ProductionLineVO();
        p5.setProductionLineId(5);
        p5.setEnterpriseId(1);
        p5.setEnable(1);
        p5.setCode(1);
        ProductionLineVO p6 = new ProductionLineVO();
        p6.setProductionLineId(6);
        p6.setEnterpriseId(2);
        p6.setEnable(1);
        p6.setCode(1);
